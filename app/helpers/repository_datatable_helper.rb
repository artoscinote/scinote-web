...
module RepositoryDatatableHelper
  ...
  def prepare_row_columns(repository_rows, repository, columns_mappings, team, options = {})
    repository_rows_with_active_reminders = RepositoryRow.in_repository_with_active_reminders(repository)
    ...
    repository_rows.map do |record|
      ...
      row = {
        ...
        'hasActiveReminders': repository_rows_with_active_reminders.include?(record),
        'rowRemindersUrl':
