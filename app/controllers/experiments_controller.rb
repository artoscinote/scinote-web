...
class ExperimentsController < ApplicationController
  ...
  def check_read_permissions
    experiment = @experiment || @experiments.first
    current_team_switch(experiment.project.team) if current_team != experiment.project.team
    (@experiments || [@experiment]).each do |e|
      render_403 unless can_read_experiment?(e) || (e.archived? && can_read_archived_experiment?(e))
    end
  end
